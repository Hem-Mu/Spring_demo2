...
public class SingletonTest {
   ...
   // AppConfig appConfig = new AppConfig();
        ...
        MemberService memberService1 = annotationConfigApplicationContext.getBean("memberService", MemberService.class); // 호출 시 객체 생성
        MemberService memberService2 = annotationConfigApplicationContext.getBean("memberService", MemberService.class); // 호출 시 객체 생성
